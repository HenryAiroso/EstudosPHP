                ...
                <div class="container">
                    <div class="row">
                        <div class="col">
                            ...
                            <button class=btnGenerate value="Clique Aqui" onclick="clickMe()"
                                onmousedown="window.location.reload()" id="button"> Contador</button>

                            <script>
                            //JS que chama o método em ClassVisitas para preencher Banco de dados a partir de PDO em ClassConexao 
                            function clickMe() {
